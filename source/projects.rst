...
All SSL publications are maintained in the Loyola University eCommons under the `SSL Collecton <https://ecommons.luc.edu/ssl_pubs>`__.

Publications prior to the formation of SSL (in 2019) can be found in the `Computer Science Collection <https://ecommons.luc.edu/cs_facpubs>`__.
